...
export const metadata: Metadata = pageMetadata({
  title: "channelmoa IPTV Reseller Program | Legal Streaming Business Tools",
  description: "Explore channelmoa IPTV reseller options for account management, renewals, trials, support workflows, and legal streaming business growth.",
  path: "/reseller"
});
      ...
      <section className="section alt">
        <div className="container grid-2">
          <div>
            ...
            <Link className="btn btn-primary" href="/contact">Request reseller details</Link>
          </div>
          <div className="card">
            <h3>Reseller fit</h3>
