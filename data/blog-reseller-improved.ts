  ...
  sections: [
    ...
    },
    {
      ...
      details: [
        ...
        "Before working with [channelmoa's reseller program](/reseller) or another supplier, request current written reseller scope, territories, packages, costs, responsibilities, data roles, escalation, and termination. Review those materials with qualified professionals and complete the operating model before accepting customer funds."
